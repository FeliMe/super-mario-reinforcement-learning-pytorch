...
class LazyFrames(object):
    def __init__(self, frames):
        ...
        This object should only be converted to numpy array before being
        passed to the model. You'd not believe how complex the previous
        solution was.
        """
        self._frames = frames
        self._out = None
...
class BufferSkipFrames(gym.Wrapper):
    ...
    def __init__(self, env=None, skip=4, shape=(84, 84)):
        ...
        self.observation_space = gym.spaces.Box(
            low=0, high=255, shape=(skip * shp[0], *shp[1:]))
        self.skip = skip
